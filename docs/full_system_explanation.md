# InsiteForge - Full System Explanation

## 1. High-Level Architecture

InsiteForge operates under a dual-client system: a visually premium, static web application hosted on Firebase, and an active Python AI engine server currently tunneled via Localtunnel (bypassing the Railway deployment limitations).
